    ...
    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
        <div class="card rounded-0 shadow">
            <div class="card-header py-1 text-center">
                ...
                <button class="btn btn-flat btn-sm btn-navy bg-gradient-navy border" id="!!delete-inmate" type="button"><i class="fa fa-archive"></i> Release</button>
...
<script>
    ...
    $(function(){
        ...
        $('#delete-inmate').click(function(){
			_conf("Are you sure to Release this Inmate?","delete_inmate",['<?= isset($id) ? $id : '' ?>'])
		})
        ...
        $('.delete-record').click(function(){
            _conf("Are you sure to Release this record?", "delete_record", [$(this).attr('data-id')])
        })
