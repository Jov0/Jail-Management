...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-navy navbar-dark elevation-4 sidebar-no-expand">
        ...
        <span class="brand-text font-weight-light text-light">BilangGo</span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-1">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="#" class="nav-link nav-release">
                    ...
                    <li class="nav-item dropdown">
                      <a href="#" class="nav-link nav-actions">
                    ...
                    <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview" style="display: none;">
                        <li class="nav-item">
                          <a href="#" class="nav-link tree-item nav-reports_record_history">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Monthly Inmate Records</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="#" class="nav-link tree-item nav-reports_visitor_report">
                            <i class="far fa-circle nav-icon"></i>
